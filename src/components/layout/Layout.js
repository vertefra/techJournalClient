    ...
    (async () => {
      try {
        const response = await axios.get(
          `${server}/users/${userIdentification.id}`
        );
      ...
      <div className="header">
        ...
        <div className="navBar">
          <div className="navItem">
            <a className="itemText" href="/dashboard">
              Dashboard
            </a>
          </div>
          <div className="navItem">
            <a className="itemText" href="/entries">
              Entries
            </a>
          </div>
          <div className="navItem">
            <a className="itemText" href="/canvas">
              Canvas
            </a>
          </div>
          <div className="navItem">
            <a className="itemText" href="/events">
              All Events
            </a>
          </div>
          <div className="navItem">
            <button className="itemText" onClick={handleLogout}>
              Log Out
            </button>
          </div>
        </div>
